...
struct CharacterDetailView: View {
    ...
    init(character: Character) {
        ...
        _intelligence = State(
            initialValue: character.attributes?["intelligence"] ?? 0)
    ...
    var body: some View {
        Form {
            ...
            Section("Attribute") {
                ...
                Stepper(
                    "Geschicklichkeit: \(agility)", value: $agility, in: 0...20)
                Stepper(
            ...
            Section {
                Button("Speichern") {
                    ...
                    updatedCharacter.equipment =
                        equipmentArray.isEmpty ? nil : equipmentArray
                    updatedCharacter.skills =
                        skillsArray.isEmpty ? nil : skillsArray
